...
#crypto                        openssl                         [botan, openssl]                Backend for cryptographical operations. Mandatory.             
#  fuzz                          disabled                        [enabled, disabled, auto]       Support for fuzz testing.                                      
#  krb5                          auto                            [enabled, disabled, auto]       Support for GSS-TSIG. Requires krb5 with gssapi.               
#  mysql                         auto                            [enabled, disabled, auto]       Support for MySQL backends.                                    
#  netconf                       auto                            [enabled, disabled, auto]       Support for kea-netconf.                                       
#  postgresql                    auto                            [enabled, disabled, auto]       Support for PostgreSQL backends.                               
